...
export const messages = {
  tr: {
    ...
    pricesStoredInUsd: "Fiyatlar USD tabanında saklanır",
    ...
    livePurchaseRequiresAuth: "Satın alma için alıcı hesabınızla giriş yapın.",
    checkoutBuyerOnly: "Lisans satın alma işlemini yalnızca alıcı hesapları tamamlayabilir.",
  ...
  en: {
    ...
    pricesStoredInUsd: "Prices are stored in USD",
    ...
    livePurchaseRequiresAuth: "Sign in with a buyer account to purchase this license.",
    checkoutBuyerOnly: "Only buyer accounts can complete a license purchase.",
