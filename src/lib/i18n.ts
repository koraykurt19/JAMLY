...
export const messages = {
  tr: {
    ...
    navSignIn: "Giriş yap",
    navProfile: "Profilim",
    profileSettings: "Pro Page ayarları",
    navDashboard: "Panel",
    ...
    handleHelp: "Küçük harf, rakam ve tire kullanın. Sistem sonuna otomatik ek yapmaz.",
    handleTaken: "Bu kullanıcı adı dolu. Lütfen farklı bir kullanıcı adı seçin.",
    role: "Rol",
    email: "E-posta",
    password: "Şifre",
    forgotPassword: "Şifremi unuttum",
    forgotPasswordEyebrow: "Parola yenileme",
    forgotPasswordTitle: "Parolanızı güvenle yenileyin",
    forgotPasswordDescription:
      "Hesabınıza bağlı e-posta adresini yazın. Size yeni parola oluşturabileceğiniz güvenli bir bağlantı göndereceğiz.",
    sendResetLink: "Yenileme bağlantısı gönder",
    resetLinkSent: "Bağlantı gönderildi",
    resetLinkSentCopy:
      "E-posta adresi bir Jamly hesabıyla eşleşiyorsa birkaç dakika içinde yenileme bağlantısı gönderilir.",
    resetPasswordEyebrow: "Yeni parola",
    resetPasswordTitle: "Yeni parolanızı belirleyin",
    resetPasswordDescription: "Hesabınız için güçlü ve daha önce kullanmadığınız bir parola seçin.",
    newPassword: "Yeni parola",
    confirmPassword: "Yeni parolayı tekrar yazın",
    passwordMinLength: "Parola en az 8 karakter olmalıdır.",
    passwordMismatch: "Parolalar birbiriyle eşleşmiyor.",
    passwordUpdated: "Parolanız güncellendi.",
    passwordUpdateError: "Parola güncellenemedi.",
    resetLinkInvalid: "Bu parola yenileme bağlantısı geçersiz veya süresi dolmuş.",
    resetLinkInvalidCopy: "Yeni bir bağlantı isteyip e-postanızdaki en güncel bağlantıyı açın.",
    backToSignIn: "Girişe dön",
    accountSecurity: "Hesap güvenliği",
    accountSecurityDescription: "Parolanızı güncellemek için güvenli ayarları açın.",
    changePassword: "Şifremi değiştir",
    sessionRequiredForPassword: "Parolanızı değiştirmek için giriş yapmanız gerekir.",
    ...
    mockPurchaseCopy: "Canlı Supabase bağlantısında bu işlem önce ödenmemiş siparişi oluşturur.",
    backToListing: "İlana dön",
    purchaseFailed: "Lisans siparişi tamamlanamadı",
    licensePurchaseRecorded: "Sipariş oluşturuldu. Teslimatın açılması için test ödemesini tamamlayın.",
  ...
  en: {
    ...
    profileSettings: "Pro Page settings",
    ...
    fullName: "Full name",
    handle: "Handle",
    handleHelp: "Use lowercase letters, numbers, and hyphens. Jamly will not add a suffix automatically.",
    ...
    forgotPasswordTitle: "Reset your password securely",
    forgotPasswordDescription:
      "Enter the email attached to your account. We will send a secure link to create a new password.",
    sendResetLink: "Send reset link",
    resetLinkSent: "Link sent",
    resetLinkSentCopy:
      "If the email matches a Jamly account, a reset link will arrive within a few minutes.",
    resetPasswordEyebrow: "New password",
    resetPasswordTitle: "Set a new password",
    resetPasswordDescription: "Choose a strong password you have not used before for this account.",
    ...
    resetLinkInvalidCopy: "Request a new link and open the latest one from your email inbox.",
    backToSignIn: "Back to sign in",
    accountSecurity: "Account security",
    accountSecurityDescription: "Open secure settings to update your password.",
    changePassword: "Change password",
    sessionRequiredForPassword: "Sign in to change your password.",
    ...
    mockPurchaseCopy: "With live Supabase, this action first creates an unpaid order.",
    backToListing: "Back to listing",
    purchaseFailed: "License order could not be completed",
    licensePurchaseRecorded: "Order created. Complete the test payment to unlock delivery.",
